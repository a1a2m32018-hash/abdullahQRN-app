...
const surahsData: [string, number, string, number][] = [
...
const surahs: Surah[] = surahsData.map(([name, page, type, ayahs], index) => ({ 
  number: index + 1, 
  name, 
  page, 
  type, 
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card)/.6)] p-4 sm:p-5">
          ...
          <p className="font-serif text-base text-[hsl(var(--foreground))] my-2 leading-loose" dir="rtl">
            اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ۚ لَا تأخذه سِنَةٌ وَلَا نَوْمٌ ۚ لَّهُ ما فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ...
          </p>
